			...
			<div class="post">
				<TR class="celula" onMouseover="this.className='celulahover'" onMouseout="this.className='celula'"  VALIGN=TOP> 
					...
					<?php if (!isset($FW_excluir))  { ?>
						...
						<td align=center><a href="<?php echo FW_RAIZ  . $view_redir ;?>devolver/id/<?php echo $reg['id'] ?>"><img src="<?php echo FW_SCAF_IMAGE; ?>icone_alterar.png" width=30 height=30 border=0></a></td>
